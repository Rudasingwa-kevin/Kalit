    ...
    >
      ...
      <div className="flex items-center h-[72px] px-6 border-b border-border-light">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-10 h-10 rounded-[14px] bg-primary flex items-center justify-center flex-shrink-0">
          ...
          <AnimatePresence>
            {!collapsed && (
              ...
              >
                <span className="text-xl font-bold tracking-tight text-primary">Kalit</span>
                <span className="text-[10px] font-medium text-accent ml-1 uppercase tracking-widest">Pro</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
