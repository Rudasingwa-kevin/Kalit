...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/8 border border-accent/10 mb-8"
            >
              <Sparkles className="w-4 h-4 text-accent" />
              <span className="text-sm font-semibold text-accent">Construction, Reimagined</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-5xl md:text-6xl lg:text-7xl font-bold text-primary tracking-tight leading-[1.05] mb-6"
            >
              The future of
              <br />
            ...
            >
              ...
              <a
                href="#features"
                className="flex items-center gap-2 px-8 py-4 text-gray-500 hover:text-primary rounded-[16px] text-base font-medium transition-colors"
              >
                See How it Works
          ...
          >
            <div className="relative mx-auto max-w-5xl">
              ...
              {/* Dashboard mockup */}
              <div className="relative bg-white rounded-[24px] border border-border/50 shadow-2xl shadow-primary/10 overflow-hidden">
                <div className="h-10 bg-surface border-b border-border-light flex items-center gap-2 px-4">
                  ...
                  <div className="flex-1 flex justify-center">
                    <div className="px-4 py-1 rounded-lg bg-white border border-border-light text-[11px] text-gray-400">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <p className="text-xs text-gray-400 font-medium uppercase tracking-widest mb-1">Today's Overview</p>
                      <h3 className="text-2xl font-bold text-primary">Good morning, Jean-Paul</h3>
                    </div>
                  ...
                  <div className="bg-surface rounded-[16px] p-6">
                    <div className="flex items-center gap-6 mb-4">
                      <span className="text-sm font-semibold text-primary">Budget Overview</span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-[14px] bg-accent/8 flex items-center justify-center mx-auto mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                className="bg-white rounded-[20px] border border-border/50 p-8 cursor-default"
              >
                <div className={`w-12 h-12 rounded-[14px] ${feature.color} flex items-center justify-center mb-5`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="text-[80px] font-black text-border/50 leading-none mb-4">{item.step}</div>
                <div className="w-12 h-12 rounded-[14px] bg-accent/8 flex items-center justify-center mb-4">
      ...
      <section id="testimonials" className="py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <p className="text-sm font-semibold text-accent uppercase tracking-widest mb-3">Testimonials</p>
            <h2 className="text-4xl md:text-5xl font-bold text-primary tracking-tight mb-4">
              Trusted by builders
            </h2>
            <p className="text-lg text-gray-400 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-white rounded-[20px] border border-border/50 p-8"
              >
                ...
                <p className="text-base text-primary leading-relaxed mb-6">"{testimonial.quote}"</p>
                <div>
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative bg-primary rounded-[32px] p-12 md:p-16 text-center overflow-hidden"
          >
            {/* Blueprint background */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 px-8 py-4 text-white/70 hover:text-white rounded-[16px] text-base font-medium transition-colors"
                >
                  Schedule a Demo
                </a>
              </div>
      ...
      {/* Footer */}
      <footer className="border-t border-border-light py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <img src="/kalit-logo.png" alt="Kalit" className="h-7 w-auto object-contain mb-4" />
            ...
            {[
              ...
              <div key={col.title}>
                <h4 className="text-sm font-semibold text-primary mb-4">{col.title}</h4>
          ...
          <div className="pt-8 border-t border-border-light flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              {['Twitter', 'LinkedIn', 'GitHub'].map(social => (
                <a key={social} href="#" className="text-sm text-gray-400 hover:text-primary transition-colors">
                  {social}
                </a>
              ))}
            </div>
